...
var REDIS_URL = process.env.COLYSEUS_PROXY_REDIS_URL || 'redis://127.0.0.1:6379'
...
function parseNode (data) {
  var _a = data.split('/'); var processId = _a[0]; var address = _a[1]
...
function listen (cb) {
  ...
  sub.on('message', function (_, message) {
    var _a = JSON.parse(message).split(','); var action = _a[0]; var data = _a[1]
